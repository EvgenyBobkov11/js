...
function learnJS(lang, callback) {
    console.log(`Я прошел курс по ${lang}`);
    callback(); // функция, которая не имеет имени и исчезнет после выполнения
}
...
learnJS('Java Script', function(){
    console.log('Я прошел этот урок!');
}); // Вторым аргументом идет функция, в которой мы и прописываем условия итд

learnJS('Java Script', done); // передаем функцию без скобочек, потому что мы не вызываем функцию, а передаем данные
